        ...
        <div className="auth-page">
            ...
            <div className="glass-panel auth-card" style={{ maxWidth: '480px' }}>
                ...
                <div style={{ position: 'relative', margin: '1.5rem 0', opacity: 0.5 }}>
                    ...
                    <span style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', background: 'var(--card-bg)', color: 'var(--fg)', padding: '0 10px', fontSize: '0.8rem' }}>OR</span>
                </div>
                ...
                <button
                    ...
                    className="btn"
                    style={{ width: '100%', background: 'var(--hover-bg)', border: '1px solid var(--glass-border)', color: 'var(--fg)', gap: '0.8rem' }}
                >
